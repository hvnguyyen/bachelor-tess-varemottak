      ...
      <header className="bg-white shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="text-gray-600">Ansatt: <span className="font-medium">{employeeId}</span></span>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ActionCard href="/track-parcel" title="Spor Pakke" description="Søk og spor status på forsendelser i systemet." color="green" cta="Sporingsverktøy" />
          </div>
